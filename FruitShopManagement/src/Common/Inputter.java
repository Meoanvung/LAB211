...
public class Inputter {
        ...
        while (true) {
            ...
            try {
                ...
                if (number >= 0) {
                    ...
                    System.err.println("Please enter the quanity: ");
                }
            } catch (InputMismatchException e) {
                System.err.println("Just enter the quanity of the fruit ");
                sc.next();
            }
        }
    }
    ...
    public boolean shouldContinue(String msg) {
        char input = getYN(msg);
        return Character.toUpperCase(input) == 'Y';
    }
